...
import '../../send_message_cubit/send_message_cubit.dart';

class ContactSupportViewBody extends StatefulWidget {
  const ContactSupportViewBody({super.key});

  @override
  State<ContactSupportViewBody> createState() => _ContactSupportViewBodyState();
}

class _ContactSupportViewBodyState extends State<ContactSupportViewBody> {
                    ...
                    child: CustomButton(
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          MessageEntity inputMessage = MessageEntity(
                            subject: subject,
                            message: message,
